...
1. Завантаження даних python __scripts/01_prepare_data.py__. Python-скрипт завантажує і готує датасет, вибирає і отримує ембеддинги.

2. Скрипт __02_embed.py__ Отримує ембединги.

3. Завантаження даних і метадані відбувається в файлі __03_load_to_pinecone.py__. Цей скрипт створює індекс у Pinecone і завантажує дані в Pinecone батчами.

4. Пошукові запити створюються в файлі __04_search.py.py__. Цей скрипт виконує чистий семантичний пошук, пошук з фільтрацією та порівняння різних метрик схожості на локальних ембедингах.

5. Чанкінг. Скрипт __05_chunking.py__ розбиває довгі анотації статей на чанки, створює ембеддинги для кожного чанка і завантажує їх в окремі індекси Pinecone.

6. Гибридний пошук. Скрипт __06_hybrid_search.py__ виконує гібридний пошук по корпусу статей, об’єднуючи BM25 і векторне ранжування за допомогою RRF.
